<div class="drop drop-report drop-style">
    ...
    <div class="drop-header">
        <div class="title">{lang('Повідомити про появу','newLevel')}</div>
    </div>
...
<div class="d_n" data-clone="data-report">
    <form method="post" action="" id="data-report" onsubmit="ImageCMSApi.formAction('/shop/ajax/getApiNotifyingRequest', '#data-report', {literal}{drop: '.drop-report', callback: function(msg, status, form, DS) {
        ...
        <div class="horizontal-form">
            <label>
                <span class="title">{lang('Ваше ім`я:','newLevel')}</span>
            ...
            <label>
                ...
                <span class="frame-form-field">
                    ...
                    <span class="must">*</span>
                    <span class="help-block">{lang('Ви отримаєте лист, коли товар буде доступний','newLevel')}</span>
                </span>
            </label>
            <label>
            ...
            <label>
                <span class="title">{lang('Коментар:','newLevel')}</span>
            ...
            <div class="frame-label">
                ...
                <span class="frame-form-field">
                    <div class="btn-form">
                        <button type="submit">
                            <span class="text-el">{lang('Відправити','newLevel')}</span>
                        </button>
                    </div>
                </span>
            </div>
