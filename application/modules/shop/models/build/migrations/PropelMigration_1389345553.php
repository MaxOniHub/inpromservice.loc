 ...
 * up to version 1389345553.
 * Generated on 2014-01-10 11:19:13 by andrij
 */
class PropelMigration_1389345553
{
...
ALTER TABLE `shop_delivery_methods` DROP `delivery_sum_specified`;

ALTER TABLE `shop_delivery_methods_i18n` DROP FOREIGN KEY `shop_delivery_methods_i18n_FK_1`;

ALTER TABLE `shop_delivery_methods_i18n` DROP `delivery_sum_specified_message`;
