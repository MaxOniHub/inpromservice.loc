 ...
 * up to version 1388742205.
 * Generated on 2014-01-03 11:43:25 by andrij
 */
class PropelMigration_1388742205
{
...
DROP INDEX `external_id` ON `shop_category`;
...
DROP INDEX `external_id` ON `shop_product_properties`;
...
DROP INDEX `external_id` ON `shop_product_variants`;
...
CREATE INDEX `external_id` ON `shop_category` (`external_id`);
...
ALTER TABLE `shop_kit` DROP `only_for_logged`;
...
CREATE INDEX `external_id` ON `shop_product_properties` (`external_id`);
...
CREATE INDEX `external_id` ON `shop_product_variants` (`external_id`);
