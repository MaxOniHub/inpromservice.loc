...
abstract class BaseShopKit extends ShopBaseObject  implements Persistent
{
	...
	public function setOnlyForLogged($v)
	{
		...
		if ($this->only_for_logged !== $v) {
			...
			$this->modifiedColumns[] = ShopKitPeer::ONLY_FOR_LOGGED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->only_for_logged = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
			$this->resetModified();
			...
			return $startcol + 5; // 5 = ShopKitPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(ShopKitPeer::ONLY_FOR_LOGGED)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setOnlyForLogged($arr[$keys[4]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(ShopKitPeer::ONLY_FOR_LOGGED)) $criteria->add(ShopKitPeer::ONLY_FOR_LOGGED, $this->only_for_logged);
