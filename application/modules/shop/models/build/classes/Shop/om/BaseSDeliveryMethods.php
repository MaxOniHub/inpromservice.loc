...
abstract class BaseSDeliveryMethods extends ShopBaseObject  implements Persistent
{
	...
	public function setDeliverySumSpecified($v)
	{
		...
		if ($this->delivery_sum_specified !== $v) {
			...
			$this->modifiedColumns[] = SDeliveryMethodsPeer::DELIVERY_SUM_SPECIFIED;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->delivery_sum_specified = ($row[$startcol + 6] !== null) ? (boolean) $row[$startcol + 6] : null;
			$this->resetModified();
			...
			return $startcol + 7; // 7 = SDeliveryMethodsPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(SDeliveryMethodsPeer::DELIVERY_SUM_SPECIFIED)) {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setDeliverySumSpecified($arr[$keys[6]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SDeliveryMethodsPeer::DELIVERY_SUM_SPECIFIED)) $criteria->add(SDeliveryMethodsPeer::DELIVERY_SUM_SPECIFIED, $this->delivery_sum_specified);
