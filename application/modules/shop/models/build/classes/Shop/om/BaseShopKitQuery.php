 ...
 * @method     ShopKitQuery orderByOnlyForLogged($order = Criteria::ASC) Order by the only_for_logged column
 *
 ...
 * @method     ShopKitQuery groupByOnlyForLogged() Group by the only_for_logged column
 *
 ...
 * @method     ShopKit findOneByOnlyForLogged(boolean $only_for_logged) Return the first ShopKit filtered by the only_for_logged column
 *
 ...
 * @method     array findByOnlyForLogged(boolean $only_for_logged) Return ShopKit objects filtered by the only_for_logged column
 *
...
abstract class BaseShopKitQuery extends ModelCriteria
{
	...
	public function filterByOnlyForLogged($onlyForLogged = null, $comparison = null)
	{
		if (is_string($onlyForLogged)) {
			$only_for_logged = in_array(strtolower($onlyForLogged), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
		}
		return $this->addUsingAlias(ShopKitPeer::ONLY_FOR_LOGGED, $onlyForLogged, $comparison);
	}
