 ...
 * @method     SDeliveryMethodsQuery orderByDeliverySumSpecified($order = Criteria::ASC) Order by the delivery_sum_specified column
 *
 ...
 * @method     SDeliveryMethodsQuery groupByDeliverySumSpecified() Group by the delivery_sum_specified column
 *
 ...
 * @method     SDeliveryMethods findOneByDeliverySumSpecified(boolean $delivery_sum_specified) Return the first SDeliveryMethods filtered by the delivery_sum_specified column
 *
 ...
 * @method     array findByDeliverySumSpecified(boolean $delivery_sum_specified) Return SDeliveryMethods objects filtered by the delivery_sum_specified column
 *
...
abstract class BaseSDeliveryMethodsQuery extends ModelCriteria
{
	...
	public function filterByDeliverySumSpecified($deliverySumSpecified = null, $comparison = null)
	{
		if (is_string($deliverySumSpecified)) {
			$delivery_sum_specified = in_array(strtolower($deliverySumSpecified), array('false', 'off', '-', 'no', 'n', '0', '')) ? false : true;
		}
		return $this->addUsingAlias(SDeliveryMethodsPeer::DELIVERY_SUM_SPECIFIED, $deliverySumSpecified, $comparison);
	}
