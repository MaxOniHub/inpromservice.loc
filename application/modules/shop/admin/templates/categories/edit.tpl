                                        ...
                                        <div class="controls">
                                            <select name="ParentId" id="ParentId" value="">
                                                ...
                                                {foreach $categories as $category}
                                                    <option
                                                        {if $category['id']==$modelArray.Id}
                                                            disabled="disabled"
                                                        {/if}
                                                        {if $category['id']==$modelArray.ParentId}
                                                            selected="selected"
                                                        {/if}
                                                        {if in_array($modelArray.Id, $category['full_path_ids'])}
                                                            disabled="disabled"
                                                        {/if}
                                                        value="{$category['id']}"> {str_repeat('-',count($category['full_path_ids']))} {echo ShopCore::encode($category['name'])}
                                                    </option>
                                                {/foreach}
                                            </select>
                                        </div>
