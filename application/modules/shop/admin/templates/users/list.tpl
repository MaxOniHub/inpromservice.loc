        ...
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                <div class="d-i_b">
                    ...
                    <button title="{lang('Cancel filter','admin')}" onclick="if(!$(this).hasClass('disabled')) location.href = '/admin/components/run/shop/users/index'" type="button" class="btn btn-small action_on {if $_GET == null || ($_GET['_pjax']!=null && count($_GET ==1))}disabled {/if}"><i class="icon-refresh"></i>{lang('Cancel filter','admin')}</button>
                                            ...
                                            <div class="form-horizontal">
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="radio" name="export" id="csv" value="csv" checked="checked"/>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label">
                                                ...
                                                <div class="mailChimpSettings" style="display: none">
                                                    ...
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <button type="button" class="btn btn-small tt" ><i class="icon-plus-sign"></i>{lang('Save','admin')}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
