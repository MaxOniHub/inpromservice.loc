            ...
            {if sizeof($model)}
                <div class="tab-content">
                            ...
                            <table class="table table-striped table-bordered table-hover table-condensed">
                                <thead>
                                    <tr>
                                        ...
                                        <th title="{lang('Sort by number','admin')}">{lang('ID','admin')}</th>
                    ...
                    <div style="padding:10px 10px 0 20px;">
                        <div id="totalCallbacks"><b>{if ShopCore::$_GET.status != -1}{lang('All Callbacks ','admin')} :{else:}{lang('Found results','admin')}:{/if}</b> {$totalCallbacks}</div>
                    </div>
                </div>
            {else:}
