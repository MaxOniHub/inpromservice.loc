                                        ...
                                        <div class="form-horizontal">
                                            <div data-frame>
                                                <div class="control-group span9 p-r_25">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" id="Name" name="Name" value="{echo ShopCore::encode($model->getName())}"  class="required alert alert-error">
                                                    </div>
                                                </div>
                                                <div class="span3">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls number">
                                                        <div class="o_h">
                                                            <input type="text" id="oldP" value="" name="OldPrice"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="control-group">
