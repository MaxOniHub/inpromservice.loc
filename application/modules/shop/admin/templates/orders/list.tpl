                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="span1" id="orderId">
                                ...
                                {if isset(ShopCore::$_GET['orderMethod']) AND ShopCore::$_GET['orderMethod'] == 'Id'}
                        ...
                        <tr class="head_body">
                            ...
                            <td class="number">
                                <label>
                                    <span class="pull-left"><span class="neigh_form_field help-inline"></span>{lang('from','admin')}&nbsp;&nbsp;</span>
                                    <span class="o_h d_b"><input value="{echo ShopCore::$_GET['amount_from']}" type="text" data-placement="top" data-original-title="{lang('numbers only','admin')}" name="amount_from"></span>
                                </label>
                                <label>
                                    <span class="pull-left"><span class="neigh_form_field help-inline"></span>{lang('to','admin')}&nbsp;&nbsp;</span>
                                    <span class="o_h d_b"><input value="{echo ShopCore::$_GET['amount_to']}" type="text" data-placement="top" data-original-title="{lang('numbers only','admin')}" name="amount_to"></span>
                                </label>
                            </td>
                            <td>
                                <select name="paid">
                                    <option {if !ShopCore::$_GET['paid']} selected="selected" {/if} value="">-- none --</option>
                                    <option {if "0" === ShopCore::$_GET['paid']} selected="selected" {/if} value="0">{echo lang('No','admin')}</option>
                                    <option {if "1" == ShopCore::$_GET['paid']} selected="selected" {/if} value="1">{echo lang('Yes','admin')}</option>
                                </select>
                            </td>
                        </tr>
                    </thead>
