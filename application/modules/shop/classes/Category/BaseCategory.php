...
class BaseCategory extends \ShopController {
    ...
    public function __construct() {
        ...
        /* if some of parent categories is disabled then 404 */
        (TRUE === $this->areAllParentsActive($this->categoryModel->getId())) OR $this->core->error_404();
    ...
    public function __CMSCore__() {
        if (!is_numeric(\ShopCore::$_GET['per_page']) && \ShopCore::$_GET['per_page'] != NULL)
            $this->core->error_404();
