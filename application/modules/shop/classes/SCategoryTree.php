...
class SCategoryTree {
     ...
     * @return array
     */
    public function getTree($mode = self::MODE_SINGLE) {
        ...
        $result = $ci->db
                ->join('shop_category_i18n', "shop_category_i18n.id=shop_category.id AND shop_category_i18n.locale='{$locale}'", 'left')
     ...
     * @return type
     */
    public function getTree_($mode = SCategoryTree::MODE_SINGLE) {
        $this->loadCategories();
        // Set tree mode
