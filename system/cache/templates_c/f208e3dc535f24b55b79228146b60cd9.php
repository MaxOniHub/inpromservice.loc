...
<html>
    ...
    <body>
        <?php $this->include_tpl('inc/javascriptVars', '/home/u14026/public_html/inpromservice.com.ua/templates/administrator'); ?>
        <?php $this->include_tpl('inc/jsLangs.tpl', '/home/u14026/public_html/inpromservice.com.ua/templates/administrator'); ?>
                                                        ...
                                                        <li <?php if($sli['divider']): ?> class="divider"<?php endif; ?><?php if($sli['header']): ?> class="nav-header"<?php endif; ?>>
                                                            <?php if($sli['link']  ||  $sli['id']): ?>
                                                                <a 
                                                                    ...
                                                                    >
                                                                    <?php echo (bool) $sli['text'] ?lang( $sli['text'] ): $sli['text']    ?>
                                                                </a>
                                                            <?php else:?>
    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span4 t-a_r">
                ...
                <a href="http://docs.imagecms.net" target="blank"><?php echo lang ('Documentation','admin'); ?></a>
            </div>
        </div>
    </div>
</footer>
...
<?php $mabilis_ttl=1460567188; $mabilis_last_modified=1390384462; ///home/u14026/public_html/inpromservice.com.ua/templates/administrator/main.tpl ?>