...
<script type="text/template" id="cartPopupTemplate">
        ...
        <div class="title bask"><span><?php echo lang ('В корзине','newLevel'); ?></span> <span class="add-info"><span class="topCartCount"><%- Shop.Cart.totalCount %></span></span> <span class="plurProd"><%- pluralStr(Shop.Cart.totalCount, plurProd) %></span> <span><?php echo lang ('Сумма','newLevel'); ?></span> <span class="add-info"><span class="topCartTotalPrice"><%- parseFloat(Shop.Cart.totalPrice).toFixed(pricePrecision) %></span></span> <%-curr%></div>
        </div>
        </div>
        ...
        <span class="s-t"><?php echo lang ('Ваша текущая скидка','newLevel'); ?>:</span>
        ...
        <span class="text-el"><span class="f-s_14">←</span> <?php echo lang ('Вернуться к оформлению','newLevel'); ?></span>
        </button>
        </div>
        <% } %>
        <span class="s-t"><?php echo lang ('Всего','newLevel'); ?>:</span>
        ...
        <span class="text-el"><span class="f-s_14">←</span> <?php echo lang ('Повернутися до покупок','newLevel'); ?></span>
        </button>
        </div>
        <div class="btn-cart btn-cart-p f_r">
        <a href="/shop/cart">
        <span class="icon_cart_p"></span>
        <span class="text-el"><?php echo lang ('Оформити замовлення','newLevel'); ?></span>
        </a>
        </div>
        </div>
        </div>
...
#?>
            ...
            <div>
                <div class="btn-autocomplete">
                    <a href="<?php echo shop_url ('search'); ?>?text=<%- items.queryString %>"  class="f-s_0 t-d_u">
                        <span class="icon_show_all"></span><span class="text-el"><?php echo lang ('Посмотреть все результаты','newLevel'); ?> →</span>
                    </a>
                </div>
                <!-- End. Show link  -->
                <% } else {%>    
            ...
            <div class="inside-padd cofirm w-s_n-w">
                <div class="btn-def">
                    <button type="button" data-button-confirm data-modal="true">
                        <spna class="text-el"><?php echo lang ('Подтвердить' , 'newLevel'); ?></spna>
                    </button>
                </div>
                <div class="btn-cancel">
                    <button type="button" data-closed="closed-js">
                        <spna class="text-el d_l_1"><?php echo lang ('Отменить' , 'newLevel'); ?></spna>
                    </button>
                </div>
            </div>
        </div>
    ...
    <button style="display: none;" type="button" data-drop="#confirm"  data-modal="true" data-confirm="true" data-effect-on="fadeIn" data-effect-off="fadeOut"></button><?php $mabilis_ttl=1460566825; $mabilis_last_modified=1459372328; ///home/u14026/public_html/inpromservice.com.ua/templates/newLevel/shop/js_templates.tpl ?>